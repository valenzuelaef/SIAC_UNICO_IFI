(function ($, undefined) {
    ...
    var Form = function ($element, options) {
        $.extend(this, $.fn.ServiceLockForm.defaults, $element.data(), typeof options === 'object' && options);
        this.setControls({
            form: $element
    ...
    Form.prototype = {
        ...
        ValidateStatusLine: function () {
            ...
            if (statusLine == "Desactivo") {
                ...
                alert("La línea no puede ser bloqueada debido a que se encuentra Inactiva", 'Alerta', function () { parent.window.close(); }); return;
            } if (that.IsLockedLine()) {
                controls.chkBloqueoLinea.attr("checked", false);
                alert("La línea se encuentra Bloqueada", 'Alerta'); return;
            }
        },
        ...
        render: function () {
            ...
            controls.chkBloqueoEquipo.prop('checked', true);
            that.chkBloqueoLinea_Click();
                ...
                "columnDefs": [{
                    ...
                    render: function (data, type, full, meta) {
                        var $rb = $('<input>', {
                            ...
                            name: 'optionsRadios',
                            id: full._strNumeroIMEI + "|" + full._strMarca
                        });
                        if (full._strEstado == "BLOQUEADO") $rb.attr('disabled', true);
                        else that.isOkBloqEq = true;
        ...
        GetCurrentLocks: function () {
            ...
            $.app.ajax({
                ...
                success: function (response) {
                    if (response.data.length == 0) that.isOkLineBloq = true;
        ...
        isOkLineBloq: false,
        CodeMotive: { "Robo": "Robo", "Hurto": "Hurto", "Perdida": "Perdida", "Pérdida": "Pérdida" },
        lstLinesLocks: null,
        ...
        getTypeLock: function () {
            if ($("#ddlMotive option:selected").val() != "-1" || $("#ddlMotive option:selected").text() != "Seleccionar") {
                return $("#ddlMotive option:selected").text();
            } else {
                return "";
            }
            ...
            that.ValidateControl(function () {
                ...
                if ($('#formLock').valid()){
                    ...
                    if (that.canLock){
                        ...
                        if (that.isOkLineBloq && that.isOkBloqEq) {
                            if (tip == "1" || tip == "2"){
                                that.lockService();
                            } else {
                                that.lockService();
        ...
        $.fn.ServiceLockForm = function () {
            ...
            this.each(function () {
                ...
                var $this = $(this),
                    data = $this.data('ServiceLockForm'),
                    options = $.extend({}, $.fn.ServiceLockForm.defaults,
                        $this.data(), typeof option === 'object' && option);

                if (!data) {
                    data = new Form($this, options);
                    $this.data('ServiceLockForm', data);
                }
    ...
    $.fn.ServiceLockForm.defaults = {
    }
    $('#ServiceLockForm').ServiceLockForm();
})(jQuery);