...
namespace Claro.SIACU.Entity.IFI.Postpaid
{
    ...
    {
        [DataMember]
        public string _TRANSACTION_NAME { get; set; }

        [DataMember]
        public string _X_INTERACTION_NUMBER { get; set; }
        ...
        [DataMember]
        public string _X_BIRTHDAY { get; set; } //
        ...
        [DataMember]
        public string _X_IDCARD_LEGAL_REP { get; set; }
        ...
        [DataMember]
        public string _X_EXPIRE_DATE { get; set; } //
        ...
        [DataMember]
        public string _HAVE_DATA { get; set; }
        ...
        [DataMember]
        public int _NUMBER_DAYS { get; set; }
        ...
        [DataMember]
        public string _X_OLD_TRIO { get; set; }

        [DataMember]
        public string _X_FLAG_CONTINGENCY { get; set; }
    }
}
